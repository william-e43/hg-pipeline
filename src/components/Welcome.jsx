...
const Welcome = (props) => {
  return(
    <div>
      ...
      <p>We’ve designed the process of taking this journey to fit <i>your</i> budget.  You choose how many of the preliminary steps you want us to do for you knowing that, <b>should you be eligible to get your record cleared, the fees for those steps we took for you will be applied against the fee for seeking to clear your record.</b> </p>
